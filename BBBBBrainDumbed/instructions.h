...
Instructions::Instructions()
{
	...
	inst.insert(make_pair(L"shl.1", Instruction(21)));
	inst.insert(make_pair(L"shr.1", Instruction(22)));
	inst.insert(make_pair(L"asr.1", Instruction(23)));
	inst.insert(make_pair(L"rol.1", Instruction(24)));
	inst.insert(make_pair(L"ror.1", Instruction(25)));
	...
	inst.insert(make_pair(L"shl.4", Instruction(37)));
	inst.insert(make_pair(L"shr.4", Instruction(38)));
	inst.insert(make_pair(L"asr.4", Instruction(39)));
	inst.insert(make_pair(L"rol.4", Instruction(40)));
	inst.insert(make_pair(L"ror.4", Instruction(41)));
